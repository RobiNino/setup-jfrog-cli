...
const rest = __importStar(require("@octokit/rest"));
...
class Utils {
    ...
    static populateCodeScanningSarif() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Read all sections and construct the final markdown file
                const sarifContent = yield this.readCodeScanningSarif();
                if (sarifContent.length == 0) {
                    core.debug('No code scanning sarif file was found.');
                    return;
                }
                yield this.uploadCodeScanningSarif(sarifContent);
            }
            catch (error) {
    ...
    static uploadCodeScanningSarif(sarif) {
        return __awaiter(this, void 0, void 0, function* () {
            // TODO token?
     ...
     */
    static readCodeScanningSarif() {
        return __awaiter(this, void 0, void 0, function* () {
            const outputDir = Utils.getJobOutputDirectoryPath();
            const fullPath = path.join(outputDir, this.CODE_SCANNING_SARIF_FILE_SUBDIRECTORY, this.CODE_SCANNING_SARIF_FILE_NAME);
...
Utils.COMMAND_SUMMARY_DIR_NAME = 'jfrog-command-summary';
...
Utils.CODE_SCANNING_SARIF_FILE_SUBDIRECTORY = 'code-scanning';
// Code scanning sarif expected file name.
Utils.CODE_SCANNING_SARIF_FILE_NAME = 'sarif';
// Inputs
// Version input
